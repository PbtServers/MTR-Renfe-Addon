...
public class BlockPlatformBarrierSlab extends BlockExtension implements PlatformHelper {


    public BlockPlatformBarrierSlab(BlockSettings blockSettings) {
    ...
    public VoxelShape getOutlineShape2(BlockState blockState, BlockView world, BlockPos pos, ShapeContext context) {
        return IBlock.getVoxelShapeByDirection(0.0, 0.1, 0, 16, 8, 16, IBlock.getStatePropertySafe(blockState, FACING));
    }
